...
<script>
    ...
    document.querySelectorAll('.mode-btn, #mode-btn').forEach(function(button) {
    ...
    document.querySelector('#'+action).classList.remove('d-none');
</script>
...
sessionFlashClear();
//if connection is closed then its need start mysqli_connect otherwise getting error "mysqli_error already closed" when you page refreshed
// $mysqli->close(); 
?>
